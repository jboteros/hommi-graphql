...
export type GetPropertiesCountByCityQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPropertiesCountByCityQuery = { __typename?: 'Query', getPropertiesCountByCity: Array<{ __typename?: 'CityPropertyCount', count?: number | null, city?: string | null }> };
...
export const GetPropertiesCountByCityDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPropertiesCountByCity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPropertiesCountByCity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"count"}},{"kind":"Field","name":{"kind":"Name","value":"city"}}]}}]}}]} as unknown as DocumentNode<GetPropertiesCountByCityQuery, GetPropertiesCountByCityQueryVariables>;
